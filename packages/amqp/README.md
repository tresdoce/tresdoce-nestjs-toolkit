<div align="center">
    ...
    <h1>Tresdoce NestJs Toolkit<br/>Amqp</h1>
</div>
...
<div align="center">
    ...
    <img alt="GitHub package.json version" src="https://img.shields.io/github/package-json/v/tresdoce/tresdoce-nestjs-toolkit?filename=packages%2Famqp%2Fpackage.json">
    <br/>
</div>
<br/>
...
```
npm install @tresdoce-nestjs-toolkit/amqp
```

```
yarn install @tresdoce-nestjs-toolkit/amqp
```
