 ...
 * The 'size' parameter defaults to 20 if not provided, if invalid, or if it exceeds the maximum allowed value (MAX_SIZE).
 *
 ...
 *   console.log(pagination.size); // Number of items per page, defaults to 20 if not provided or invalid
 ...
 * GET /items  // 'page' defaults to 1 and 'size' defaults to 20
 * // Query with invalid page
 * GET /items?page=invalid&size=10  // 'page' defaults to 1
 * // Query with invalid size
 * GET /items?page=2&size=invalid  // 'size' defaults to 20
 */
