...
<div align="center">
    ...
    <img alt="GitHub package.json version" src="https://img.shields.io/github/package-json/v/tresdoce/tresdoce-nestjs-toolkit?filename=packages%2Ftracing%2Fpackage.json">
    <br/>
</div>
<br/>
...
```
npm install @tresdoce-nestjs-toolkit/tracing
```

```
yarn install @tresdoce-nestjs-toolkit/tracing
```
