<div align="center">
    ...
    <h1>Tresdoce NestJs Toolkit<br/>Logging</h1>
</div>
...
<div align="center">
    ...
    <img alt="GitHub package.json version" src="https://img.shields.io/github/package-json/v/tresdoce/tresdoce-nestjs-toolkit?filename=packages%2Flogging%2Fpackage.json">
    <br/>
</div>
<br/>
...
```
npm install @tresdoce-nestjs-toolkit/logging
```

```
yarn install @tresdoce-nestjs-toolkit/logging
```
