...
<div align="center">
    ...
    <img alt="GitHub package.json version" src="https://img.shields.io/github/package-json/v/tresdoce/tresdoce-nestjs-toolkit?filename=packages%2Ffilters%2Fpackage.json">
    <br/>
</div>
<br/>
...
```
npm install @tresdoce-nestjs-toolkit/filters
```

```
yarn install @tresdoce-nestjs-toolkit/filters
```
